...
namespace ezSCORES.API.Controllers
{
	...
	[ApiController]
	public class CompetitionsRefereesController : BaseCRUDController<CompetitionsReferees, BaseSearchObject, CompetitionRefereeInsertRequest, CompetitionRefereeUpdateRequest>
	{
